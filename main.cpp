...
int main()
{
    ...
    cout << "  4.  A " << NTRIALS
         ...
         << endl;
    cout << "  5.  A good player against a human player" << endl;
    cout << "  6.  A " << NTRIALS << "-game mini - game between two mediocre players" << endl;
    ...
    else if (line[0] == '3')
    {
        ...
        cout << "The good player won " << nGoodWins << " out of "
            << NTRIALS << " games." << endl;
        // We'd expect a good player to win most of the games against
        // an mediocre player.  Similarly, a good player should outperform
        // a mediocre player.
    }
    else if (line[0] == '5') {
        Game g(10, 10);
